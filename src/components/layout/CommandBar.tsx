...
export function CommandBar({ onRun, onStop }: Props) {
  ...
  return (
    <div className="flex items-center h-11 px-3 bg-bg-surface border-b border-border gap-1 shrink-0">
      {/* Logo */}
      ...
      <div className="relative">
        ...
        {showNewMenu && (
          <div className="absolute top-full left-0 mt-1 w-64 bg-bg-elevated border border-border rounded-xl shadow-xl z-50 max-h-80 overflow-y-auto">
            <button
              onClick={() => {
                newBlankProject();
      ...
      <div className="relative">
        ...
        {showExportMenu && (
          <div className="absolute top-full left-0 mt-1 w-52 bg-bg-elevated border border-border rounded-xl shadow-xl z-50">
            <button
